...
Scenario: restrict to movies with 'PG' or 'R' ratings
  ...
  Then I should see (Terminator,When Harry Met Sally,Amelie,Incredibles,Raiders of the Lost Ark)
  And I should not see (Aladdin,Help,Chocolat,2001: A Space Odyssey,Chicken Run)  
  

Scenario: no ratings selected
  When I uncheck the following ratings: PG,R,PG-13,G
  And I press "ratings_submit"
  Then I should see no of the movies  
